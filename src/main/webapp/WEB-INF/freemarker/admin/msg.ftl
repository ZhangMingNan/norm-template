...
<head>
    ...
    <style type="text/css">
        ...
        *{ padding:0; margin:0; font-size:12px}
        ...
        .showMsg h5{background-image: url(${basePath}/statics/images/msg_img/msg.png);background-repeat: no-repeat; color:#fff; padding-left:35px; height:25px; line-height:26px;*line-height:28px; overflow:hidden; font-size:14px; text-align:left}
        .showMsg .content{ padding:46px 12px 10px 45px; font-size:14px; height:64px; text-align:left}
        .showMsg .bottom{ background:#e4ecf7; margin: 0 1px 1px 1px;line-height:26px; *line-height:30px; height:26px; text-align:center}
        .showMsg .ok,.showMsg .guery{background: url(${basePath}/statics/images/msg_img/msg_bg.png) no-repeat 0px -560px;}
        .showMsg .guery{background-position: left -460px;}
        -->
    </style>
    <script type="text/javaScript" src="${basePath}/statics/js/jquery.min.js"></script>
    <script language="JavaScript" src="${basePath}/statics/js/admin_common.js"></script>
</head>
<body>
